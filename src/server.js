...
import { addFeedback, emptyState, publicState, transitionProposal } from "./core.js";
...
const store = new JsonStore(process.env.RSI_STATE_PATH ?? join(root, ".data/state.json"));
